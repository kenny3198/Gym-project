...
const ContactUs = ({setSelectedPage}: Props) => {
 ...
 >
     ...
     <p className='my-5'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eligendi inventore 
        debitis ipsa optio assumenda doloremque. Hic recusandae laboriosam tenetur.
     </p>
     </motion.div>
     {/* FORM AND IMAGES */}
         <div className='mt-10 justify-between gap-8 md:flex'>
            <motion.div className='mt-10 md:mt-0 basis-3/5'
            initial='hidden'
            whileInView='visible'
            viewport={{once: true, amount: 0.5}}
            transition={{delay:0.2, duration: 0.5}}
            ...
            >
              ...
              action='https://formSubmit.co/abdulbaqhussain2018@gmail.com'
               onSubmit={onSubmit}>
               ...
               <input className={`${inputStyle}`} type="text"
                 ...
                 <p className='mt-1 text-primary-500 '>
                    ...
                    {errors.message.type === "pattern" && "MaxLength is 2000 char"}
                 </p>
                 )}
                  <button type='submit' className='mt-5 rounded-lg
                   bg-secondary-500 px-20 py-3 transsition duration-500 hover:text-white'>
                      SUBMIT
                  </button>
              </form>
            </motion.div>
            ...
            <div className='md:before:content-evolvetext w-full
             before:absolute before:-bottom-20 before:-right-10 before:z-[-1]'> 
                <img className='w-full ' src={ContactUsGraphic} alt="contact-us-graphic" />
            </div>
            </motion.div>
         </div>
 </motion.div>
